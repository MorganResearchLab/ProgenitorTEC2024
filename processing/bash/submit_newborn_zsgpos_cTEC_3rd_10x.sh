...
HTO_LIBFILE="/nfs/research1/marioni/mdmorgan/Thymus_Newborn/lib_files/Newborn_ZsGpos_3rdRun_cTEC_HTO.tsv"  
ADT_LIBFILE="/nfs/research1/marioni/mdmorgan/Thymus_Newborn/lib_files/Newborn_ZsGpos_3rdRun_cTEC_ADT.tsv"

ADT_REFLIB="/nfs/research1/marioni/mdmorgan/Thymus_Newborn/refs/Newborn_ZsGpos_3rdRun_cTEC_ADT_refs.tsv"
HTO_REFLIB="/nfs/research1/marioni/mdmorgan/Thymus_Newborn/refs/Newborn_ZsGpos_3rdRun_cTEC_HTO_refs.tsv"

# I need to run the feature barcoding for the CITE-seq antibodies and hashtags separately

ADT_ID="Newborn_ZsGpos_3rdRun_cTEC_ADT"
HTO_ID="Newborn_ZsGpos_3rdRun_cTEC_HTO"
