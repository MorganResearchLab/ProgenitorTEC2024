...
HTO_LIBFILE="/nfs/research1/marioni/mdmorgan/Thymus_Newborn/lib_files/Newborn_ZsGneg_3rdRun_mTEC_HTO.tsv"  
ADT_LIBFILE="/nfs/research1/marioni/mdmorgan/Thymus_Newborn/lib_files/Newborn_ZsGneg_3rdRun_mTEC_ADT.tsv"

ADT_REFLIB="/nfs/research1/marioni/mdmorgan/Thymus_Newborn/refs/Newborn_ZsGneg_3rdRun_mTEC_ADT_refs.tsv"
HTO_REFLIB="/nfs/research1/marioni/mdmorgan/Thymus_Newborn/refs/Newborn_ZsGneg_3rdRun_mTEC_HTO_refs.tsv"

# I need to run the feature barcoding for the CITE-seq antibodies and hashtags separately

ADT_ID="Newborn_ZsGneg_3rdRun_mTEC_ADT"
HTO_ID="Newborn_ZsGneg_3rdRun_mTEC_HTO"
