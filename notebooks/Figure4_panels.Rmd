...
perinatal.nhood.meta <- read.table("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/results/Milo_res-ZsGCompare.txt",
...
```{r "load iTEC data"}
itec.milo <- readRDS(file="~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/results/iTEC_Milo.RDS")

itec.nhood.annot <- read.table("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/results/iTEC_Nhood_map.tsv",
...
ggsave(umap.plot, filename="~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_ComAnot-UMAP.png",
...
itec.chat <- filterCommunication(itec.chat, min.cells=10) # fitler interactions involving fewer than 10 cells
```
...
png("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat_allPathways-heatmap.png",
...
png("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat-Outgoing_NMF-heatmap.png",
...
png("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat-Outgoing_NMF_Pathways-heatmap.png",
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat_Ly6d-OutgoingPathwayContribution-bubble.png",
...
png("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat-Incoming_NMF-heatmap.png",
...
png("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat-Incoming_NMF_Pathways-heatmap.png",
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat_Ly6d-IncomingPathwayContribution-bubble.png",
       height=3, width=8, dpi=300, bg='white')
```
...
```{r}
ly6d.dge <- read.table("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/results/iTEC_Ly6d_DEGs.tsv",
                       sep="\t", header=TRUE, stringsAsFactors=FALSE)
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Ly6dp_vs_Ly6dn-CellChat_receptors-volcano.png",
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Ly6dp_vs_Ly6dn-CellChat_ligands-volcano.png",
       height=5, width=8, dpi=300, bg='white')
```
...
```{r, fig.height=18}
#par(mfrow=c(1,1))
png(file="~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat_FGF-ChordAgg.png",
...
```{r, fig.height=18}
#par(mfrow=c(1,1))
png(file="~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat_WNT-ChordAgg.png",
    height=18, width=18, units="in", res=300)
...
```{r, fig.height=18}
#par(mfrow=c(1,1))
png(file="~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat_BMP-ChordAgg.png",
    height=18, width=18, units="in", res=300)
...
```{r, fig.height=18}
#par(mfrow=c(1,1))
png(file="~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat_IGF-ChordAgg.png",
    height=18, width=18, units="in", res=300)
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_CellChat-JAM_contribution.png",
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_CellChat-GALECTIN_contribution.png",
       height=4, width=6, dpi=300, bg='white')
```
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_CellChat-GRN_contribution.png",
       height=4, width=6, dpi=300, bg='white')
```
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_CellChat-CCL_contribution.png",
       height=4, width=6, dpi=300, bg='white')
```
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_CellChat-CADM_contribution.png",
       height=4, width=6, dpi=300, bg='white')
```
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_CellChat-EPHA_contribution.png",
       height=4, width=6, dpi=300, bg='white')
```
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_CellChat-MPZ_contribution.png",
       height=4, width=6, dpi=300, bg='white')
```
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_CellChat-NRXN_contribution.png",
       height=4, width=6, dpi=300, bg='white')
```
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_CellChat-SLURP_contribution.png",
       height=4, width=6, dpi=300, bg='white')
```
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_CellChat-ACTIVIN_contribution.png",
       height=4, width=6, dpi=300, bg='white')
```
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_CellChat-FGF_contribution.png",
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat-Fgfr-violin.png",
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat-Fgfligand-violin.png",
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_CellChat-OCLN_contribution.png",
       height=2.5, width=6, dpi=300, bg='white')
```
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_CellChat-ANGPT_contribution.png",
       height=2.5, width=6, dpi=300, bg='white')
```
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_CellChat-PRPS_contribution.png",
       height=2.5, width=6, dpi=300, bg='white')
```
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_CellChat-GAS_contribution.png",
       height=2.5, width=6, dpi=300, bg='white')
```
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_CellChat-BMP_contribution.png",
       height=2.5, width=6, dpi=300, bg='white')
```
...
png("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat_BMP-Centrality.png",
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_CellChat-WNT_contribution.png",
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat-Wntreceptors-violin.png",
       height=7, width=12, dpi=300, bg='white')
```
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat-Wntreceptors_LEGEND-violin.png",
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat-Wntligand-violin.png",
       height=12, width=12, dpi=300, bg='white')
```
...
png("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat_WNT-Centrality.png",
    height=6.5, width=16.5, res=300, units="in")
# Visualize the computed centrality scores using heatmap, allowing ready identification of major signaling roles of cell groups
netAnalysis_signalingRole_network(itec.chat, signaling = pathways.show, width = 16, height = 6, font.size = 14, color.use=samp.cols,
                                  font.size.title = 14, cluster.rows=TRUE, cluster.cols=TRUE)
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/Perinatal_CellChat-TRAIL_contribution.png",
       height=4, width=6, dpi=300, bg='white')
```
...
ggsave("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat-IGFreceptors-violin.png",
       height=7, width=12, dpi=300, bg='white')
```
...
png("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat-PathwaysHighlight-Ligands-heatmap.png",
...
png("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat-PathwaysHighlight-Receptors-heatmap.png",
    height=9, width=8, res=900, units="in")
...
png("~/Dropbox/Mike Morgan/AgeingExperiment/Perinatal_manuscript/figures/CellChat-TECGroup-legend.png",
